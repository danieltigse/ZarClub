...
function msjConfirmacion(){
    var nombres=document.getElementById("doctores");
    var dia=document.getElementById("anio_2");
    var mes=document.getElementById("anio_1");
    var anio=document.getElementById("anio");
    request = crearXMLHttpRequest( );
    request.open("GET","consultaDoc?accion=msj&nombres="+nombres.value+"&dia="+dia.value+"&mes="+mes.value+"&anio="+anio.value,true);
    request.onreadystatechange=manejadorMsj;
    request.send(null);
}

function manejadorMsj()
{
    var resp=request.responseXML;
    var x=resp.getElementsByTagName("msj");
    var y=resp.getElementsByTagName("hora");
    var msj=document.getElementById("msj");
    var hora=document.getElementById("hora");
    while(msj.hasChildNodes()) {
        msj.removeChild(msj.lastChild);
    }
    while(hora.hasChildNodes()) {
        hora.removeChild(hora.lastChild);
    }
    msj.appendChild(document.createTextNode(x[0].firstChild.nodeValue));
    hora.setAttribute("value", y[0].firstChild.nodeValue);
